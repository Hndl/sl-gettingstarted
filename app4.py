...
idx2 = pd2.date_range("2023-07-11 10:05", "2023-07-13 23:00", freq='60min')
...
dfT = pd2.DataFrame({'datetime': idx2, 'Ambient-Temperature': amb_points, 'Dew-Point-Temperature': dew_points})
